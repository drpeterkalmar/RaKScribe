...
class GigaScribeApp:
    ...
    def copy_formatted_report(self):
        try:
            ...
            # Schritt 1: Konvertiere den korrigierten Markdown-Text in HTML
            html_output = markdown.markdown(markdown_text_corrected)
            
            # Fügen Sie einen minimalen HTML-Header hinzu, damit Word die Formatierung korrekt interpretiert
            html_content = f"""
            <html>
            ...
            # Schritt 2: Kopiere den HTML-Inhalt in die Zwischenablage
