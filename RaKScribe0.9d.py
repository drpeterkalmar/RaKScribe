## RaKScribe - Version 0.9d - stable mit verbesserter med. Spracherkennung
...
MEDICAL_PHRASES = [
    ...
    "Fraktur", "Spondylodese", "Arthrose", "Coxarthrose", "Gonarthrose", "Meniskus", "Hinterhorn-Läsion",
    "Korbhenkelriss", "Bandscheibenprotrusion", "Bandscheibenprolaps", "Spinalkanalstenose", "Osteochondrose",
